...
BOT_USERNAME = getenv("BOT_USERNAME", "MinatoMusic_Bot")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002842347858))
...
# ───── Git & Updates ───── #
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/hwop/AnnieXMusic")
