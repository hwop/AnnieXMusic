...
async def init():
    ...
    LOGGER("ANNIEMUSIC.plugins").info("ʜᴡ ᴍᴜsɪᴄ'ꜱ ᴍᴏᴅᴜʟᴇs ʟᴏᴀᴅᴇᴅ...")
    ...
    LOGGER("ANNIEMUSIC").info(
        "ʜᴡ ᴍᴜsɪᴄ ʀᴏʙᴏᴛ sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ..."
    )
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ANNIEMUSIC").info("sᴛᴏᴘᴘɪɴɢ ʜᴡ ᴍᴜsɪᴄ ʙᴏᴛ ...")
